...
const SectionPage = () => {
  ...
  return (
    <>
      <div className="pt-[30px] 	 bg-slate-700 ">
        <div className="mx-auto max-w-2xl    lg:max-w-7xl 	 ">
          ...
          <div className="mt-6 grid  grid-cols-2 md:grid-cols-2 2xl:grid-cols-3  ml-[65px] gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-5">
            {data.map((product) => (
